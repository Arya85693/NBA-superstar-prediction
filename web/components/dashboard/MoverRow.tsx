...
export function MoverRow({
  ...
  return (
    <Link
      ...
      className={
        showSparkline
          ? "group grid grid-cols-[2rem_1fr_auto_auto] items-center gap-x-4 gap-y-0.5 rounded-xl px-2 py-4 transition hover:bg-surface-muted/90 sm:grid-cols-[2.25rem_1fr_auto_auto] sm:gap-x-5 md:py-[1.125rem]"
          : "group grid grid-cols-[2rem_1fr_auto] items-center gap-x-4 gap-y-0.5 rounded-xl px-2 py-4 transition hover:bg-surface-muted/90 sm:grid-cols-[2.25rem_1fr_auto] sm:gap-x-5 md:py-[1.125rem]"
      }
    >
      ...
      {showSparkline ? <SparklinePlaceholder positive={positive} /> : null}
